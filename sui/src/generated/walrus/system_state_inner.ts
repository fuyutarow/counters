...
import * as bls_aggregate from "./bls_aggregate";
import * as event_blob from "./event_blob";
import * as extended_field from "./extended_field";
import * as storage_accounting from "./storage_accounting";

const $moduleName = "Walrus::system_state_inner";
