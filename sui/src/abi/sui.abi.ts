 ...
 * Generated at: 2025-12-02T11:38:39.650Z
 */
...
export interface Accumulator_settlementEventStreamHeadType {
  mmr: string[];
...
export interface Coin_registryCoinRegistryType {
  id: { id: string };
}

export interface Coin_registryCurrencyType {
  id: { id: string };
  decimals: number;
  name: string;
  symbol: string;
  ...
  metadata_cap_id: unknown;
  extra_fields: unknown;
}

export interface Coin_registryCurrencyInitializerType {
  currency: unknown;
  extra_fields: unknown;
  is_otw: boolean;
}

export interface Coin_registryCurrencyKeyType {
  dummy_field: boolean;
}

export interface Coin_registryExtraFieldType {
  pos0: unknown;
  pos1: Uint8Array;
}

export interface Coin_registryMetadataCapType {
  id: { id: string };
}
...
export interface Funds_accumulatorWithdrawalType {
  owner: string;
  limit: string;
}
...
export function isAccumulatorAccumulatorRootType(data: unknown): data is AccumulatorAccumulatorRootType {
...
export function isAccumulator_metadataMetadataType(data: unknown): data is Accumulator_metadataMetadataType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAccumulator_metadataMetadataKeyType(data: unknown): data is Accumulator_metadataMetadataKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAccumulator_metadataOwnerType(data: unknown): data is Accumulator_metadataOwnerType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAccumulator_metadataOwnerKeyType(data: unknown): data is Accumulator_metadataOwnerKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAccumulator_settlementEventStreamHeadType(data: unknown): data is Accumulator_settlementEventStreamHeadType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["mmr", "checkpoint_seq", "num_events"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }

  // string型フィールドの型確認
  const stringFields: string[] = ["checkpoint_seq", "num_events"];
  for (const field of stringFields) {
    if (typeof obj[field] !== "string") return false;
  }
...
export function isAuthenticator_stateActiveJwkType(data: unknown): data is Authenticator_stateActiveJwkType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAuthenticator_stateAuthenticatorStateType(data: unknown): data is Authenticator_stateAuthenticatorStateType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAuthenticator_stateAuthenticatorStateInnerType(data: unknown): data is Authenticator_stateAuthenticatorStateInnerType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isAuthenticator_stateJwkIdType(data: unknown): data is Authenticator_stateJwkIdType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoinRegulatedCoinMetadataType(data: unknown): data is CoinRegulatedCoinMetadataType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoin_registryCoinRegistryType(data: unknown): data is Coin_registryCoinRegistryType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoin_registryCurrencyType(data: unknown): data is Coin_registryCurrencyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["id", "decimals", "name", "symbol", "description", "icon_url", "supply", "regulated", "treasury_cap_id", "metadata_cap_id", "extra_fields"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }

  // string型フィールドの型確認
  const stringFields: string[] = ["name", "symbol", "description", "icon_url"];
  for (const field of stringFields) {
    if (typeof obj[field] !== "string") return false;
  }
...
export function isCoin_registryCurrencyInitializerType(data: unknown): data is Coin_registryCurrencyInitializerType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["currency", "extra_fields", "is_otw"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }
...
export function isCoin_registryCurrencyKeyType(data: unknown): data is Coin_registryCurrencyKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoin_registryExtraFieldType(data: unknown): data is Coin_registryExtraFieldType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["pos0", "pos1"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }
...
export function isCoin_registryMetadataCapType(data: unknown): data is Coin_registryMetadataCapType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isDeny_listPerTypeConfigCreatedType(data: unknown): data is Deny_listPerTypeConfigCreatedType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isDerived_objectDerivedObjectKeyType(data: unknown): data is Derived_objectDerivedObjectKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isDynamic_object_fieldWrapperType(data: unknown): data is Dynamic_object_fieldWrapperType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isFunds_accumulatorWithdrawalType(data: unknown): data is Funds_accumulatorWithdrawalType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["owner", "limit"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }

  // string型フィールドの型確認
  const stringFields: string[] = ["owner", "limit"];
  for (const field of stringFields) {
    if (typeof obj[field] !== "string") return false;
  }
...
export function isGroth16PreparedVerifyingKeyType(data: unknown): data is Groth16PreparedVerifyingKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["vk_gamma_abc_g1_bytes", "alpha_g1_beta_g2_bytes", "gamma_g2_neg_pc_bytes", "delta_g2_neg_pc_bytes"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }
...
export function isGroth16PublicProofInputsType(data: unknown): data is Groth16PublicProofInputsType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isKiosk_extensionExtensionType(data: unknown): data is Kiosk_extensionExtensionType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isKiosk_extensionExtensionKeyType(data: unknown): data is Kiosk_extensionExtensionKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isNitro_attestationNitroAttestationDocumentType(data: unknown): data is Nitro_attestationNitroAttestationDocumentType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;

  // 必須フィールドの存在確認
  const requiredFields = ["module_id", "timestamp", "digest", "pcrs", "public_key", "user_data", "nonce"];
  for (const field of requiredFields) {
    if (!(field in obj)) return false;
  }
...
export function isNitro_attestationPCREntryType(data: unknown): data is Nitro_attestationPCREntryType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isPriority_queuePriorityQueueType(data: unknown): data is Priority_queuePriorityQueueType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isTransfer_policyTransferPolicyType(data: unknown): data is Transfer_policyTransferPolicyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isTransfer_policyTransferPolicyCapType(data: unknown): data is Transfer_policyTransferPolicyCapType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isTransfer_policyTransferPolicyCreatedType(data: unknown): data is Transfer_policyTransferPolicyCreatedType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isTransfer_policyTransferPolicyDestroyedType(data: unknown): data is Transfer_policyTransferPolicyDestroyedType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isTransfer_policyTransferRequestType(data: unknown): data is Transfer_policyTransferRequestType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isVersionedVersionChangeCapType(data: unknown): data is VersionedVersionChangeCapType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isZklogin_verified_idVerifiedIDType(data: unknown): data is Zklogin_verified_idVerifiedIDType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
  ...
  // string型フィールドの型確認
  const stringFields: string[] = ["owner", "key_claim_name", "key_claim_value", "issuer", "audience"];
  for (const field of stringFields) {
    if (typeof obj[field] !== "string") return false;
  }
...
export function isZklogin_verified_issuerVerifiedIssuerType(data: unknown): data is Zklogin_verified_issuerVerifiedIssuerType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function parseAccumulatorAccumulatorRoot(json: unknown): AccumulatorAccumulatorRootType | null {
...
export function parseAccumulator_metadataMetadata(json: unknown): Accumulator_metadataMetadataType | null {
  return isAccumulator_metadataMetadataType(json) ? json : null;
}

export function parseAccumulator_metadataMetadataKey(json: unknown): Accumulator_metadataMetadataKeyType | null {
  return isAccumulator_metadataMetadataKeyType(json) ? json : null;
}

export function parseAccumulator_metadataOwner(json: unknown): Accumulator_metadataOwnerType | null {
  return isAccumulator_metadataOwnerType(json) ? json : null;
}

export function parseAccumulator_metadataOwnerKey(json: unknown): Accumulator_metadataOwnerKeyType | null {
  return isAccumulator_metadataOwnerKeyType(json) ? json : null;
}

export function parseAccumulator_settlementEventStreamHead(json: unknown): Accumulator_settlementEventStreamHeadType | null {
  return isAccumulator_settlementEventStreamHeadType(json) ? json : null;
}

export function parseAuthenticator_stateActiveJwk(json: unknown): Authenticator_stateActiveJwkType | null {
  return isAuthenticator_stateActiveJwkType(json) ? json : null;
}

export function parseAuthenticator_stateAuthenticatorState(json: unknown): Authenticator_stateAuthenticatorStateType | null {
  return isAuthenticator_stateAuthenticatorStateType(json) ? json : null;
}

export function parseAuthenticator_stateAuthenticatorStateInner(json: unknown): Authenticator_stateAuthenticatorStateInnerType | null {
...
export function parseCoinRegulatedCoinMetadata(json: unknown): CoinRegulatedCoinMetadataType | null {
...
export function parseCoin_registryCoinRegistry(json: unknown): Coin_registryCoinRegistryType | null {
  return isCoin_registryCoinRegistryType(json) ? json : null;
}

export function parseCoin_registryCurrency(json: unknown): Coin_registryCurrencyType | null {
  return isCoin_registryCurrencyType(json) ? json : null;
}

export function parseCoin_registryCurrencyInitializer(json: unknown): Coin_registryCurrencyInitializerType | null {
  return isCoin_registryCurrencyInitializerType(json) ? json : null;
}

export function parseCoin_registryCurrencyKey(json: unknown): Coin_registryCurrencyKeyType | null {
  return isCoin_registryCurrencyKeyType(json) ? json : null;
}

export function parseCoin_registryExtraField(json: unknown): Coin_registryExtraFieldType | null {
  return isCoin_registryExtraFieldType(json) ? json : null;
}

export function parseCoin_registryMetadataCap(json: unknown): Coin_registryMetadataCapType | null {
  return isCoin_registryMetadataCapType(json) ? json : null;
}
...
export function parseDeny_listPerTypeConfigCreated(json: unknown): Deny_listPerTypeConfigCreatedType | null {
...
export function parseDerived_objectDerivedObjectKey(json: unknown): Derived_objectDerivedObjectKeyType | null {
...
export function parseDynamic_object_fieldWrapper(json: unknown): Dynamic_object_fieldWrapperType | null {
  return isDynamic_object_fieldWrapperType(json) ? json : null;
}

export function parseFunds_accumulatorWithdrawal(json: unknown): Funds_accumulatorWithdrawalType | null {
  return isFunds_accumulatorWithdrawalType(json) ? json : null;
}
...
export function parseGroth16PreparedVerifyingKey(json: unknown): Groth16PreparedVerifyingKeyType | null {
...
export function parseKiosk_extensionExtensionKey(json: unknown): Kiosk_extensionExtensionKeyType | null {
...
export function parseNitro_attestationNitroAttestationDocument(json: unknown): Nitro_attestationNitroAttestationDocumentType | null {
  return isNitro_attestationNitroAttestationDocumentType(json) ? json : null;
}

export function parseNitro_attestationPCREntry(json: unknown): Nitro_attestationPCREntryType | null {
...
export function parsePriority_queuePriorityQueue(json: unknown): Priority_queuePriorityQueueType | null {
...
export function parseTransfer_policyTransferPolicy(json: unknown): Transfer_policyTransferPolicyType | null {
  return isTransfer_policyTransferPolicyType(json) ? json : null;
}

export function parseTransfer_policyTransferPolicyCap(json: unknown): Transfer_policyTransferPolicyCapType | null {
  return isTransfer_policyTransferPolicyCapType(json) ? json : null;
}

export function parseTransfer_policyTransferPolicyCreated(json: unknown): Transfer_policyTransferPolicyCreatedType | null {
  return isTransfer_policyTransferPolicyCreatedType(json) ? json : null;
}

export function parseTransfer_policyTransferPolicyDestroyed(json: unknown): Transfer_policyTransferPolicyDestroyedType | null {
  return isTransfer_policyTransferPolicyDestroyedType(json) ? json : null;
}

export function parseTransfer_policyTransferRequest(json: unknown): Transfer_policyTransferRequestType | null {
...
export function parseVersionedVersionChangeCap(json: unknown): VersionedVersionChangeCapType | null {
...
export function parseZklogin_verified_idVerifiedID(json: unknown): Zklogin_verified_idVerifiedIDType | null {
  return isZklogin_verified_idVerifiedIDType(json) ? json : null;
}

export function parseZklogin_verified_issuerVerifiedIssuer(json: unknown): Zklogin_verified_issuerVerifiedIssuerType | null {
...
export const suiPackage = {
  ...
  balance: {
    ...
    create_supply_internal(
      ...
      return tx.moveCall({
        target: `${packageId}::balance::create_supply_internal`,
        arguments: [],
      });
    },
    decrease_supply(
    ...
    redeem_funds(
      ...
      return tx.moveCall({
        target: `${packageId}::balance::redeem_funds`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    send_funds(
      ...
      return tx.moveCall({
        target: `${packageId}::balance::send_funds`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    ...
    withdraw_funds_from_object(
      ...
      return tx.moveCall({
        target: `${packageId}::balance::withdraw_funds_from_object`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
  ...
  coin: {
    allow_global_pause(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::allow_global_pause`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    ...
    create_currency(
      tx: Transaction,
      options: {
        arguments: readonly [TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument];
        typeArguments?: readonly string[];
      }
    ): TransactionResult {
      return tx.moveCall({
    ...
    create_regulated_currency_v2(
      tx: Transaction,
      options: {
        arguments: readonly [TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument];
        typeArguments?: readonly string[];
      }
    ): TransactionResult {
      return tx.moveCall({
    ...
    deny_cap_id(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::deny_cap_id`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    ...
    destroy_metadata(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::destroy_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    ...
    new_coin_metadata(
      tx: Transaction,
      options: {
        arguments: readonly [TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument];
        typeArguments?: readonly string[];
      }
    ): TransactionResult {
      return tx.moveCall({
        target: `${packageId}::coin::new_coin_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    new_deny_cap_v2(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::new_deny_cap_v2`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    new_treasury_cap(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::new_treasury_cap`,
        arguments: [],
      });
    },
    put(
    ...
    redeem_funds(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::redeem_funds`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    send_funds(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::send_funds`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    ...
    update_coin_metadata(
      ...
      return tx.moveCall({
        target: `${packageId}::coin::update_coin_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
  ...
  coin_registry: {
    burn(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::burn`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    burn_balance(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::burn_balance`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    claim_metadata_cap(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::claim_metadata_cap`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    decimals(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::decimals`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    delete_metadata_cap(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::delete_metadata_cap`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    delete_migrated_legacy_metadata(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::delete_migrated_legacy_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    deny_cap_id(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::deny_cap_id`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    description(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::description`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    exists(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::exists`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    finalize(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::finalize`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    finalize_registration(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::finalize_registration`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    icon_url(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::icon_url`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    is_metadata_cap_claimed(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::is_metadata_cap_claimed`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    is_metadata_cap_deleted(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::is_metadata_cap_deleted`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    is_regulated(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::is_regulated`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    is_supply_burn_only(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::is_supply_burn_only`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    is_supply_fixed(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::is_supply_fixed`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    make_regulated(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::make_regulated`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    make_supply_burn_only(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::make_supply_burn_only`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    make_supply_burn_only_init(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::make_supply_burn_only_init`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    make_supply_fixed(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::make_supply_fixed`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    make_supply_fixed_init(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::make_supply_fixed_init`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    metadata_cap_id(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::metadata_cap_id`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    migrate_legacy_metadata(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::migrate_legacy_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    migrate_regulated_state_by_cap(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::migrate_regulated_state_by_cap`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    migrate_regulated_state_by_metadata(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::migrate_regulated_state_by_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    name(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::name`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    new_currency(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::new_currency`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    new_currency_with_otw(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::new_currency_with_otw`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    set_description(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::set_description`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    set_icon_url(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::set_icon_url`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    set_name(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::set_name`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    set_treasury_cap_id(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::set_treasury_cap_id`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    symbol(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::symbol`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    total_supply(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::total_supply`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    treasury_cap_id(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::treasury_cap_id`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    update_from_legacy_metadata(
      ...
      return tx.moveCall({
        target: `${packageId}::coin_registry::update_from_legacy_metadata`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    }
  ...
  config: {
    add_for_next_epoch(
      tx: Transaction,
      options: {
        arguments: readonly [TransactionArgument, TransactionArgument, TransactionArgument, TransactionArgument];
        typeArguments?: readonly string[];
      }
    ): TransactionResult {
      return tx.moveCall({
  ...
  event: {
    ...
    emit_authenticated(
      ...
      return tx.moveCall({
        target: `${packageId}::event::emit_authenticated`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    }
  ...
  funds_accumulator: {
    add_impl(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::add_impl`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    create_withdrawal(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::create_withdrawal`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    redeem(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::redeem`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    withdraw_from_object(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::withdraw_from_object`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    withdrawal_join(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::withdrawal_join`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    withdrawal_limit(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::withdrawal_limit`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    withdrawal_owner(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::withdrawal_owner`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    },
    withdrawal_split(
      ...
      return tx.moveCall({
        target: `${packageId}::funds_accumulator::withdrawal_split`,
        ...(options.typeArguments?.length && { typeArguments: options.typeArguments as string[] }),
        arguments: [...options.arguments],
      });
    }
  ...
  object: {
    ...
    sui_coin_registry_address(
      ...
      return tx.moveCall({
        target: `${packageId}::object::sui_coin_registry_address`,
        arguments: [],
      });
    },
    sui_coin_registry_object_id(
      ...
      return tx.moveCall({
        target: `${packageId}::object::sui_coin_registry_object_id`,
        arguments: [],
      });
    },
    sui_deny_list_object_id(
