 ...
 * Generated at: 2025-09-26T19:01:59.508Z
 */
  ...
  coin_registry: {
    ...
    enums: {
      MetadataCapState: {
        ...
        variantDeclarationOrder: ["Claimed", "Unclaimed", "Deleted"],
      },
      RegulatedState: {
        abilities: {
          abilities: ["Copy", "Drop", "Store"],
        ...
        variantDeclarationOrder: ["Regulated", "Unregulated", "Unknown"],
      },
      SupplyState: {
        abilities: {
          abilities: ["Store"],
        ...
        variantDeclarationOrder: ["Fixed", "BurnOnly", "Unknown"],
      },
    },
    exposedFunctions: {
      burn: {
...
export function isCoin_registryCoinRegistryType(
  data: unknown,
): data is Coin_registryCoinRegistryType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoin_registryCurrencyInitializerType(
  data: unknown,
): data is Coin_registryCurrencyInitializerType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoin_registryCurrencyKeyType(
  data: unknown,
): data is Coin_registryCurrencyKeyType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isCoin_registryMetadataCapType(
  data: unknown,
): data is Coin_registryMetadataCapType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function isFunds_accumulatorWithdrawalType(
  data: unknown,
): data is Funds_accumulatorWithdrawalType {
  if (!data || typeof data !== "object") return false;
  const obj = data as Record<string, unknown>;
...
export function parseCoin_registryCoinRegistry(
  json: unknown,
): Coin_registryCoinRegistryType | null {
...
export function parseCoin_registryCurrencyInitializer(
  json: unknown,
): Coin_registryCurrencyInitializerType | null {
...
export function parseFunds_accumulatorWithdrawal(
  json: unknown,
): Funds_accumulatorWithdrawalType | null {
...
export const suiPackage = {
  ...
  balance: {
    ...
    create_supply_internal(tx: Transaction): TransactionResult {
      return tx.moveCall({
  ...
  coin: {
    ...
    new_treasury_cap(tx: Transaction): TransactionResult {
      return tx.moveCall({
  ...
  object: {
    ...
    sui_coin_registry_address(tx: Transaction): TransactionResult {
      return tx.moveCall({
        target: `${packageId}::object::sui_coin_registry_address`,
        arguments: [],
      });
    },
    sui_coin_registry_object_id(tx: Transaction): TransactionResult {
      return tx.moveCall({
